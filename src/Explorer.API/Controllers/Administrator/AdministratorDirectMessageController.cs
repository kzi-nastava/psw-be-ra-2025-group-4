...
namespace Explorer.API.Controllers.Administrator
{
    ...
    [Route("api/administration/messages")]
    [ApiController]
    public class AdministratorDirectMessageController : ControllerBase
    {
        private readonly IDirectMessageService _directMessageService;

        public AdministratorDirectMessageController(IDirectMessageService directMessageService)
        {
